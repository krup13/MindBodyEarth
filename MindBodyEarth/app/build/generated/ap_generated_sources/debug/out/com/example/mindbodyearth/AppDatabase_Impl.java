...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `carbon_footprint_table` (`energyConsumption` TEXT, `transportation` TEXT, `meal` TEXT, `waste` TEXT, `date` TEXT, `total_footprint` REAL NOT NULL, `energy_footprint` REAL NOT NULL, `transportation_footprint` REAL NOT NULL, `meal_footprint` REAL NOT NULL, `waste_footprint` REAL NOT NULL, PRIMARY KEY(`date`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS `energy_consumption_table` (`electricity_usage` REAL NOT NULL, `gas_usage` REAL NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS `transportation_table` (`mode_of_transportation` TEXT, `distance_travelled` REAL NOT NULL, `fuel_efficiency` REAL NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS `waste_table` (`waste_generated` REAL NOT NULL, `recycling_rate` REAL NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS `journal_table` (`year` TEXT, `entries` TEXT, PRIMARY KEY(`year`))");
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `meditation_articles` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `articleLink` TEXT, `favorites` INTEGER NOT NULL, `title` TEXT, `bookmarks` TEXT)");
        db.execSQL("CREATE TABLE IF NOT EXISTS `meditation_videos` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `youtubeLink` TEXT, `favorites` INTEGER NOT NULL, `title` TEXT)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '65f836f59410353ffe5b4cfe29c9a8a6')");
      }
      ...
      public void dropAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("DROP TABLE IF EXISTS `meditation_videos`");
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsCarbonFootprintTable.put("date", new TableInfo.Column("date", "TEXT", false, 1, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        final HashMap<String, TableInfo.Column> _columnsEnergyConsumptionTable = new HashMap<String, TableInfo.Column>(2);
        ...
        final HashMap<String, TableInfo.Column> _columnsTransportationTable = new HashMap<String, TableInfo.Column>(3);
        ...
        final HashMap<String, TableInfo.Column> _columnsWasteTable = new HashMap<String, TableInfo.Column>(2);
        ...
        _columnsJournalTable.put("year", new TableInfo.Column("year", "TEXT", false, 1, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsMeditationArticles.put("id", new TableInfo.Column("id", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMeditationArticles.put("articleLink", new TableInfo.Column("articleLink", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        final HashMap<String, TableInfo.Column> _columnsMeditationVideos = new HashMap<String, TableInfo.Column>(4);
        _columnsMeditationVideos.put("id", new TableInfo.Column("id", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMeditationVideos.put("youtubeLink", new TableInfo.Column("youtubeLink", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMeditationVideos.put("favorites", new TableInfo.Column("favorites", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMeditationVideos.put("title", new TableInfo.Column("title", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        final HashSet<TableInfo.ForeignKey> _foreignKeysMeditationVideos = new HashSet<TableInfo.ForeignKey>(0);
        final HashSet<TableInfo.Index> _indicesMeditationVideos = new HashSet<TableInfo.Index>(0);
        final TableInfo _infoMeditationVideos = new TableInfo("meditation_videos", _columnsMeditationVideos, _foreignKeysMeditationVideos, _indicesMeditationVideos);
        final TableInfo _existingMeditationVideos = TableInfo.read(db, "meditation_videos");
        if (!_infoMeditationVideos.equals(_existingMeditationVideos)) {
          return new RoomOpenHelper.ValidationResult(false, "meditation_videos(com.example.mindbodyearth.Entities.Meditation.MeditationVideo).\n"
                  + " Expected:\n" + _infoMeditationVideos + "\n"
                  + " Found:\n" + _existingMeditationVideos);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "65f836f59410353ffe5b4cfe29c9a8a6", "a45e9fac060b89c43d40034d61dabcc1");
  ...
  public void clearAllTables() {
    ...
    try {
      ...
      _db.execSQL("DELETE FROM `meditation_videos`");
