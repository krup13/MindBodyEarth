  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `meal_plan_table` (`meals` TEXT, `day` TEXT)");
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `workout_plan_table` (`workoutRoutine` TEXT)");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '1d0432bb9a3816a44f0915c7dea8b5e0')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsWorkoutPlanTable.put("workoutRoutine", new TableInfo.Column("workoutRoutine", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "1d0432bb9a3816a44f0915c7dea8b5e0", "34aa352e6eb2b5946a0dc7a36bc37767");
